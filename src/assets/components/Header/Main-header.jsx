          ...
          <nav className="nav border-gray-200 px-4 lg:px-6 py-2.5">
            <div className="nav-in flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
              <Link to="/" className="flex items-center">
                ...
                <h3 className="text-black md:font-bold text-3xl ml-3 text">
                  ServiceSpire
                </h3>
              </Link>
                  ...
                  <li>
                    <NavLink
                      ...
                      className={({ isActive }) =>
                        ...
                        } border-b border-gray-100 hover:bg-gray-50 flex justify-center items-center gap-1 lg:hover:bg-transparent lg:border-0 hover:text-cyan-600 lg:p-0`
                      }
                    ><LuHouse size={20} />
                      Home
                    </NavLink>
