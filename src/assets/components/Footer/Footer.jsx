  ...
  <div className="mx-auto max-w-screen-xl px-4 pb-6 pt-16 sm:px-6 lg:px-8 lg:pt-24">
    <div className="grid grid-cols-1 gap-8 lg:grid-cols-3">
      <div>
        <div className="flex justify-center items-center text-teal-600 sm:justify-start">
          <img src={ReactLogo} alt=""/><h1 className='text-3xl'>ServiceSpire</h1>
        </div>
        ...
        <ul className="mt-8 flex justify-center gap-6 sm:justify-start md:gap-8">
          <li>
            ...
            >
              ...
              <ImFacebook2 size={24} color='#1877F2'/>
            </a>
          </li>
          ...
          <ul className="mt-8 space-y-4 text-sm">
            <li>
              ...
              >
                ...
                <span className="flex-1 text-gray-700">servicespire@gmail.com</span>
              </a>
            </li>
    ...
    <div className="mt-12 border-t border-gray-100 pt-6">
      <div className="text-center sm:flex sm:justify-between sm:text-left">
        ...
        <p className="mt-4 text-sm text-gray-500 sm:order-first sm:mt-0">&copy; 2025 ServiceSpire</p>
      </div>
    </div>
  </div>
</footer>
