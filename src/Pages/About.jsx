      ...
      <div className="body bg-gray-100">
        ...
        <div className="section-2 h-auto mr-20 ml-20 p-10 text-xl leading-9 text-neutral-700">
          <p>
            ...
            services. Our goal is to create a supportive community where
            everyone can access the help they require, whether it’s for medicine
            transportation, grocery delivery, or other vital tasks.
          </p>
          <br />

          <p>
            1. Our Vision At Servicespire, we envision a world where no one has
            ...
            <br />
            2. Our Mission Our mission is to simplify the process of seeking and
            ...
            connecting those in need with those willing to help. <br />
            <br />
            3. Our Success Story Since our launch, Servicespire has successfully
            ...
            - Secure Payment System: Users can make payments safely through our
            platform, ensuring that funds are held securely until the service is
            completed. <br />
            - User Profiles: Both users and helpers can create profiles,
            allowing for transparency and trust within the community. <br />-
            Feedback and Ratings: Users can provide feedback on their
            experiences, helping to maintain high standards of service and
            reliability. <br />
            - 24/7 Support: Our dedicated support team is available to assist
            with any questions or concerns, ensuring a smooth experience for all
            users. <br />
            Join us at Servicespire and be part of a community that cares.
            Together, we can make a difference, one helping hand at a time!
          </p>
        </div>
          ...
          <section class="bg-white dark:bg-gray-900">
            <div class="container px-6 py-10 mx-auto">
              ...
              <p class="max-w-2xl mx-auto my-6 text-center text-gray-500 dark:text-gray-300">
                Our executive team leads with vision, experience, and dedication
                to drive innovation and success. Their leadership ensures
                growth, efficiency, and a strong foundation for our future.
              </p>
